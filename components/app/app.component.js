(function (angular) {
    ...
    AppComponent.$inject = ['$window', '$log', '$http', '$scope', 'Settings', '$mdDialog', '$mdSidenav'];

    function AppComponent($window, $log, $http, $scope, Settings, $mdDialog, $mdSidenav) {
...
$ctrl.validateNewsletterRequest = validateNewsletterRequest;
        ...
        function newsletterRequest(token) {
            ...
            $ctrl.newsletterMessageColor = "unset";
            sendEmail("RemingtonDc.com Newsletter Request",
        ...
        function contactRequest() {
            ...
            $ctrl.contactMessageColor = "unset";
            sendEmail("RemingtonDc.com Contact Request",
